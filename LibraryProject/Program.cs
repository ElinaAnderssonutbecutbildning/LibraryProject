...
namespace LibraryProject
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            customerManager.AddCustomer("Lars", "Bergv 13", 0, 19930503 );
            ...
            shelfManager2.AddShelf(2,1);

            IShelfManager shelfManager3 = new ShelfManager();
            shelfManager3.AddShelf(3,1);

            IShelfManager shelfManagerOne = new ShelfManager();
            shelfManagerOne.AddShelf(1,2);

            IShelfManager shelfManagerTwo = new ShelfManager();
            shelfManagerTwo.AddShelf(2,2);

            IShelfManager shelfManagerThree = new ShelfManager();
            shelfManagerThree.AddShelf(3,2);
